...
{/* AppBar */}
      <AppBar position="absolute" className={clsx(classes.appBar, open && classes.appBarShift)}>
        <Toolbar className={classes.toolbar}>
          ...
          {initialLogin === false && <IconButton color="inherit">
            <Badge badgeContent={4} color="secondary">
              <NotificationsIcon />
            </Badge>
          </IconButton>}
          
          {initialLogin === false && <IconButton color="inherit" onClick={handleMenuClose}>
        ...
        <List>
          ...
          <div>
            ...
            <Collapse in={subMenuOpen1} timeout="auto" unmountOnExit>
              <List component="div" disablePadding>
                ...
                <ListItem button className={classes.nested}
                  component={RouterLink} to={'clinic'}>
                  <ListItemIcon className={classes.menuIcon}>
                    <SvgIcon>
                      <ClinicIcon />
                    </SvgIcon>
                ...
                <ListItem button className={classes.nested}
                  component={RouterLink} to={'patient'}>
                  <ListItemIcon className={classes.menuIcon}>
                    <SvgIcon>
                      <PatientIcon />
                    </SvgIcon>
                ...
                <ListItem button className={classes.nested}
                  component={RouterLink} to={'provider'}>
                  <ListItemIcon className={classes.menuIcon}>
                    <SvgIcon>
                      <ProviderIcon />
                    </SvgIcon>
            ...
            <Collapse in={subMenuOpen2} timeout="auto" unmountOnExit>
              ...
              <ListItem button className={classes.nested}
                component={RouterLink} to={'cptCode'}>
                <ListItemIcon className={classes.menuIcon}>
                  <SvgIcon>
                    <CPTIcon />
                  </SvgIcon>
              ...
              <ListItem button className={classes.nested}
                component={RouterLink} to={'diagnosisCode'}>
                <ListItemIcon className={classes.menuIcon}>
                  <SvgIcon>
                    <DiagIcon />
                  </SvgIcon>
              ...
              <ListItem button className={classes.nested}
                component={RouterLink} to={'noteType'}>
                <ListItemIcon className={classes.menuIcon}>
                  <SvgIcon>
                    <NoteTypeIcon />
                  </SvgIcon>
              ...
              <ListItem button className={classes.nested}
                component={RouterLink} to={'placeofservice'}>
                <ListItemIcon className={classes.menuIcon}>
                  <SvgIcon>
                    <POSIcon />
                  </SvgIcon>
              ...
              <ListItem button className={classes.nested}
                component={RouterLink} to={'treatment'}>
                <ListItemIcon className={classes.menuIcon}>
                  <SvgIcon>
                    <SpecialtyIcon />
                  </SvgIcon>
              ...
              <ListItem button className={classes.nested}
                component={RouterLink} to={'status'}>
                <ListItemIcon className={classes.menuIcon}>
                  <SvgIcon>
                    <StatusIcon />
                  </SvgIcon>
