...
import { Table, TableHead, TableRow, TableCell, TablePagination, TableSortLabel,
                ...
                <TableRow>
                    {
                        columnCells.map(columnCell => (
                            ...
                            >
                                {columnCell.disableSorting ? columnCell.label : 
                                <TableSortLabel
                                    active={orderBy === columnCell.id}
                                    direction={orderBy === columnCell.id ? order : 'asc'}
                                    onClick={() => {handleSortRequest(columnCell.id)}}
                                >
                                    {columnCell.label}
                                </TableSortLabel> }
                            </TableCell>
