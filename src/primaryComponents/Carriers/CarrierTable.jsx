...
export default function CarrierTable() {
  ...
  // RTK Data reqests
  const { data = [] } = useFetchAllCarriersQuery({
    refetchOnMountOrArgChange: true,
    skip: false,
  });
  const [addCarrier] = useAddCarrierMutation();
          ...
          return items.filter(
            (x) =>
              ...
              x.carrierShortName
                .toLowerCase()
                .includes(target.value.toLowerCase()) ||
              x.carrierContactName
                .toLowerCase()
                .includes(target.value.toLowerCase()) ||
              x.carrierContactEmail
                .toLowerCase()
                .includes(target.value.toLowerCase()) ||
  ...
  return (
    <React.Fragment>
      ...
      <Controls.Popup
        ...
        title="Carrier Form"
      >
        <CarrierForm recordForEdit={recordForEdit} addOrEdit={addOrEdit} />
      </Controls.Popup>
