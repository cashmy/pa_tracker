...
const columnCells = [
    ...
    { id: 'providerLastName', label: 'Provider' },
...
export default function ProviderTable() {
    ...
    async function getPAs() {
        try {
            const response = await PriorAuthService.getAllPAsByArchiveStatus(archiveStatus);
            ...
            fn: items => {
                ...
                if (target.value === "")
                    ...
                    return items.filter(x => (
                        ...
                        || x.carrier.carrierShortName.toLowerCase().includes(target.value.toLowerCase())
    ...
    return (
        <React.Fragment>
            ...
            <Paper className={classes.pageContent}>
                <Toolbar>
                    <Controls.Input 
                        label="Search Patient First or Last Name, Carrier, Provider, Status and Specialty"
                        fullWidth={false}
