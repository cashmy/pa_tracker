...
// non-database Select field constants
const frequency = [
...
export default function PAForm(props) {
  ...
  async function getPatientsSelect() {
    try {
      ...
      for (const [index, item] of items.entries()) {
        newItems.push({
          id: item.patientId,
          title: item.patientLastName + ", " + item.patientFirstName,
        });
      }
  ...
  async function getCarriersSelect() {
    try {
      ...
      for (const [index, item] of items.entries()) {
        newItems.push({
          id: item.carrierId,
          title: item.carrierShortName + " - " + item.carrierName,
        });
      }
      setSelectCarriers(newItems);
      return newItems;
    } catch (e) {
      console.log("Carrier API call unsuccessful", e);
    }
  }
  ...
  async function getStatusesSelect() {
    try {
      ...
      console.log("Status API call unsuccessful", e);
    }
  }
  ...
  async function getSpecialtiesSelect() {
    try {
      ...
      console.log("Treatment/Specialty API call unsuccessful", e);
    }
  }
  ...
  async function getPlacesOfServiceSelect() {
    try {
      ...
      for (const [index, item] of items.entries()) {
        newItems.push({
          id: item.placeOfServiceCode,
          title: item.placeOfServiceDesc,
        });
      }
      setSelectPlacesOfService(newItems);
      return newItems;
    } catch (e) {
      console.log("Place Of Service API call unsuccessful", e);
    }
  }
  ...
  async function getProvidersSelect() {
    try {
      ...
      for (const [index, item] of items.entries()) {
        newItems.push({
          id: item.providerId,
          title: item.providerLastName + ", " + item.providerFirstName,
        });
      }
      setSelectProviders(newItems);
      return newItems;
    } catch (e) {
      console.log("Provider API call unsuccessful", e);
    }
  }
  ...
  async function getClinicsSelect() {
    try {
      ...
      console.log("Clinc API call unsuccessful", e);
    }
  }
  ...
  async function getUsersSelect() {
    try {
      ...
      console.log("User API call unsuccessful", e);
    }
  }
